...
namespace MapsetParser.starrating.osu.skills
{
    ...
    public class Speed : OsuStrainSkill
    {
        ...
        public override double CalculateInitialStrain(double time, DifficultyHitObject current) => (currentStrain * currentRhythm) * strainDecay(time - current.Previous(0).StartTime);
